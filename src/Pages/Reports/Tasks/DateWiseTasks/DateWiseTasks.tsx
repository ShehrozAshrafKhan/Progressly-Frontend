...
const DateWiseTasks = () => {
  ...
  const handleUserReport = async (e: any) => {
    ...
    const url = `${config.baseUrl}Reports/UserDateWiseReport?userId=${userId}&fromDate=${fromDate}&toDate=${toDate}`;
    openReport(
      url,
      () => {
        handleClear();
    ...
    <Layout>
      <div className="card shadow-sm p-5">
        <div className="d-flex gap-3 align-items-center mb-3">
          ...
          />
          <h2 className="">User Date-Wise Report</h2>
        </div>
